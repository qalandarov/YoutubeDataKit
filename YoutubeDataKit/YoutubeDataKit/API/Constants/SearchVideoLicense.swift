...
/// YouTube lets video uploaders choose to attach either the Creative Commons license or the standard YouTube license
/// to each of their videos. If you specify a value for this parameter,
/// you must also set the `SearchResourceType` parameter's value to video.
